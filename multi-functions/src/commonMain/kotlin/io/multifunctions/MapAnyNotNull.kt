 ...
 * to each tuple that contains at least one non-null value.
 */
inline fun <A, B, R> Iterable<Pair<A?, B?>>.mapAnyNotNull(
    transform: (A?, B?) -> R?
 ...
 * to each tuple that contains at least one non-null value.
 */
inline fun <A, B, C, R> Iterable<Triple<A?, B?, C?>>.mapAnyNotNull(
    transform: (A?, B?, C?) -> R?
 ...
 * to each tuple that contains at least one non-null value.
 */
inline fun <A, B, C, D, R> Iterable<Quad<A?, B?, C?, D?>>.mapAnyNotNull(
    transform: (A?, B?, C?, D?) -> R?
 ...
 * to each tuple that contains at least one non-null value.
 */
inline fun <A, B, C, D, E, R> Iterable<Penta<A?, B?, C?, D?, E?>>.mapAnyNotNull(
 ...
 * to each tuple that contains at least one non-null value.
 */
inline fun <A, B, C, D, E, F, R> Iterable<Hexa<A?, B?, C?, D?, E?, F?>>.mapAnyNotNull(
 ...
 * to each tuple that contains at least one non-null value.
 */
inline fun <A, B, C, D, E, F, G, R> Iterable<Hepta<A?, B?, C?, D?, E?, F?, G?>>.mapAnyNotNull(
