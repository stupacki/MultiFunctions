...
internal class MultiMapTest {
    ...
    fun `produce a correct mapping from Pair`() {
        ...
        val result = testData.map { (one, two) ->
    ...
    fun `produce a correct mapping from Triple`() {
        ...
        val result = testData.map { (one, two, three) ->
            assertEquals("one", one)
            assertEquals("two", two)
    ...
    fun `produce a correct mapping from Quad`() {
        ...
        val result = testData.map { (one, two, three, four) ->
            assertEquals("one", one)
            assertEquals("two", two)
            assertEquals("three", three)
    ...
    fun `produce a correct mapping from Penta`() {
        ...
        val result = testData.map { (one, two, three, four, five) ->
            assertEquals("one", one)
            assertEquals("two", two)
            assertEquals("three", three)
            assertEquals("four", four)
    ...
    fun `produce a correct mapping from Hexa`() {
        ...
        val result = testData.map { (one, two, three, four, five, six) ->
            assertEquals("one", one)
            assertEquals("two", two)
            assertEquals("three", three)
            assertEquals("four", four)
    ...
    fun `produce a correct mapping from Hepta`() {
        ...
        val result = testData.map { (one, two, three, four, five, six, seven) ->
            assertEquals("one", one)
            assertEquals("two", two)
            assertEquals("three", three)
            assertEquals("four", four)
