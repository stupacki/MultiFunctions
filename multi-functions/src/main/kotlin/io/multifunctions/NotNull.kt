 ...
 */
inline fun <reified A, reified B, reified C, R> notNull(first: A?, second: B?, third: C?, block: (A, B, C) -> R) =
        when (null) {
 ...
 */
inline fun <reified A, reified B, reified C, reified D, R> notNull(first: A?, second: B?, third: C?, fourth: D?, block: (A, B, C, D) -> R) =
        when (null) {
 ...
 */
inline fun <reified A, reified B, reified C, reified D, reified E, R> notNull(first: A?, second: B?, third: C?, fourth: D?, fifth: E?, block: (A, B, C, D, E) -> R) =
        when (null) {
 ...
 */
inline fun <reified A, reified B, reified C, reified D, reified E, reified F, R> notNull(first: A?, second: B?, third: C?, fourth: D?, fifth: E?, sixth: F?, block: (A, B, C, D, E, F) -> R) =
        when (null) {
 ...
 */
inline fun <reified A, reified B, reified C, reified D, reified E, reified F, reified G, R> notNull(first: A?, second: B?, third: C?, fourth: D?, fifth: E?, sixth: F?, seventh: G?, block: (A, B, C, D, E, F, G) -> R) =
        when (null) {
