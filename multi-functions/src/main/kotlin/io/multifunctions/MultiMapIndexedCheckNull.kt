...
inline fun <A, B, R : Any> Iterable<Pair<A?, B?>>.mapIndexedCheckNull(transform: (Int, A, B) -> R): List<R> =
...
inline fun <A, B, C, R : Any> Iterable<Triple<A?, B?, C?>>.mapIndexedCheckNull(transform: (Int, A, B, C) -> R): List<R> =
...
inline fun <A, B, C, D, R : Any> Iterable<Quad<A?, B?, C?, D?>>.mapIndexedCheckNull(transform: (Int, A, B, C, D) -> R): List<R> =
...
inline fun <A, B, C, D, E, R : Any> Iterable<Penta<A?, B?, C?, D?, E?>>.mapIndexedCheckNull(transform: (Int, A, B, C, D, E) -> R): List<R> =
...
inline fun <A, B, C, D, E, F, R : Any> Iterable<Hexa<A?, B?, C?, D?, E?, F?>>.mapIndexedCheckNull(transform: (Int, A, B, C, D, E, F) -> R): List<R> =
...
inline fun <A, B, C, D, E, F, G, R : Any> Iterable<Hepta<A?, B?, C?, D?, E?, F?, G?>>.mapIndexedCheckNull(transform: (Int, A, B, C, D, E, F, G) -> R): List<R> =
