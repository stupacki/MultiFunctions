 ...
 */
public inline fun <A, B, R> Iterable<Pair<A, B>>.mapIndexed(
    transform: (Int, A, B) -> R,
): List<R> =
 ...
 * and returns the result of the transform applied to the element.
 */
public inline fun <A, B, C, R> Iterable<Triple<A, B, C>>.mapIndexed(
 ...
 * and returns the result of the transform applied to the element.
 */
public inline fun <A, B, C, D, R> Iterable<Quad<A, B, C, D>>.mapIndexed(
 ...
 * and returns the result of the transform applied to the element.
 */
public inline fun <A, B, C, D, E, R> Iterable<Penta<A, B, C, D, E>>.mapIndexed(
 ...
 * and returns the result of the transform applied to the element.
 */
public inline fun <A, B, C, D, E, F, R> Iterable<Hexa<A, B, C, D, E, F>>.mapIndexed(
 ...
 * and returns the result of the transform applied to the element.
 */
public inline fun <A, B, C, D, E, F, G, R> Iterable<Hepta<A, B, C, D, E, F, G>>.mapIndexed(
