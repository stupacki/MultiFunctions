...
inline fun <A, B, R : Any> Iterable<Pair<A?, B?>>.mapCheckNull(transform: (A, B) -> R): List<R> =
...
inline fun <A, B, C, R : Any> Iterable<Triple<A?, B?, C?>>.mapCheckNull(transform: (A, B, C) -> R): List<R> =
...
inline fun <A, B, C, D, R : Any> Iterable<Quad<A?, B?, C?, D?>>.mapCheckNull(transform: (A, B, C, D) -> R): List<R> =
...
inline fun <A, B, C, D, E, R : Any> Iterable<Penta<A?, B?, C?, D?, E?>>.mapCheckNull(transform: (A, B, C, D, E) -> R): List<R> =
...
inline fun <A, B, C, D, E, F, R : Any> Iterable<Hexa<A?, B?, C?, D?, E?, F?>>.mapCheckNull(transform: (A, B, C, D, E, F) -> R): List<R> =
